...
| --- | --- | --- | --- |
| game-director | Game Design & Production Lead | advisory | — |
| gameplay-systems | Deterministic Gameplay Engineer | edit | — |
| monogame-runtime | MonoGame Runtime Engineer | edit | — |
| runtime-diagnostics | .NET Runtime Diagnostics Specialist | advisory | — |
| visual-presentation | Pixel Art & Presentation Designer | advisory | — |
| quality-engineering | Gameplay QA & Automation Engineer | edit | — |
...
Game Design & Production Lead, Deterministic Gameplay Engineer, MonoGame Runtime Engineer, .NET Runtime Diagnostics Specialist, Pixel Art & Presentation Designer, Gameplay QA & Automation Engineer, RAI Reviewer, Fact Checker
...
- **Can:** review code and pull requests; write and modify code; write and run tests; responsible-AI and content-safety review; UX and visual design
- **Cannot (no agent claims this):** write and maintain documentation; security and secrets review; cut releases and publish packages; author and maintain CI/CD workflows; deploy to live environments
