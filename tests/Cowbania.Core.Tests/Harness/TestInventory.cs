...
internal static class TestInventory
{
    ...
    [
        ...
        "revolver projectiles expire at their maximum travel range",
        "revolver endpoint collisions resolve before range expiry",
        "enemy projectiles are exempt from the revolver range",
        ...
        "falling below a canyon restores a safe authored spawn",
        ...
        "expanded frontier keeps its authored progression anchors",
        "expanded level content stays supported unique and traversable",
        "main route contains mandatory gaps and major elevation changes",
        ...
        "enemy definitions populate varied frontier encounters",
        ...
        "dynamite armadillo blocks shell hits but is vulnerable during recovery",
        ...
        "reaching the hub exit automatically enters the branch",
        ...
        "frontier pickup clips cover coin health and ammo",
        ...
        "coins award score once and reserve ammo is cylinder-independent",
